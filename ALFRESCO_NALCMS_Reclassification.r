...
lc05.mod <- reclass(lc05.mod, "lc05.mod == 20 & gs_temp >= gs_value & treeline == 1", 0, complex=TRUE)
...
reclass(lc05.mod, "mask == 1", 2, complex=TRUE)
