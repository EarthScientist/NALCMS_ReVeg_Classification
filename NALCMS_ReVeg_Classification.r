...
output.dir <- "/workspace/UA/malindgren/projects/NALCMS_Veg_reClass/outputs/run_2/"
...
ind <- which(v.lc05 == 6 & v.CoastSpruceBog == ); values(lc05.mod)[ind] <- 0
...
ind <- which(v.lc05 == 3 & v.gs_temp < 6.5 | v.north_south == 1); values(lc05.mod)[ind] <- 3
ind <- which(v.lc05 == 3 & v.gs_temp >= 6.5 | v.north_south == 2); values(lc05.mod)[ind] <- 5
...
ind <- which(v.lc05 == 2 & v.gs_temp < 6.5 | v.north_south == 2); values(lc05.mod)[ind] <- 3
ind <- which(v.lc05 == 2 & v.gs_temp >= 6.5 | v.north_south == 1); values(lc05.mod)[ind] <- 2
